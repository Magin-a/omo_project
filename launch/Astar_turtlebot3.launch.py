...
def generate_launch_description():
    urdf_dir = get_package_share_directory('turtlebot3_description')
    sdf_dir = get_package_share_directory('turtlebot3_gazebo')
    ...
    urdf = os.path.join(
        urdf_dir, 'urdf', 'turtlebot3_' + TURTLEBOT3_MODEL + '.urdf'
    )
    sdf = os.path.join(sdf_dir,'models', 'turtlebot3_' + TURTLEBOT3_MODEL, 'model.sdf')
